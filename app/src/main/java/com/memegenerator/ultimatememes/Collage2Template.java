...
public class Collage2Template extends Fragment {
    ...
    private View mRoot;
    private FloatingActionButton mFab_collage2;
    private int LOADIMG1_RESULT = 1;
    private int LOADIMG2_RESULT = 2;

    public Collage2Template() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         mRoot = inflater.inflate(R.layout.fragment_collage2_template, container, false);
        //Get and initialize the views
         GetViews();

        mFab_collage2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mFab_collage2.setVisibility(mRoot.GONE);
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bitmap bitmap = screenShot(mRoot.findViewById(R.id.cardview_collage2));
    ...
    private void GetViews() {
        mEditTextBody = mRoot.findViewById(R.id.editText_body_collage2);
        mEditTextLabel = mRoot.findViewById(R.id.editText_label_collage2);
        mBtnSave = mRoot.findViewById(R.id.button_save_collage2);
        mTextViewBody = mRoot.findViewById(R.id.textView_body_collage2);
        mTextViewLabel = mRoot.findViewById(R.id.textView_label_collage2);
        mImageViewUploadAndUploaded1 = mRoot.findViewById(R.id.imageView_uploaded1_collage2);
        mImageViewUploadAndUploaded2 = mRoot.findViewById(R.id.imageView_uploaded2_collage2);
        mFab_collage2 = mRoot.findViewById(R.id.fab_collage2);
    }
}
